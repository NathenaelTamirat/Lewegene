...
import { Calendar, Users, Plus, Trash2, AlertTriangle } from 'lucide-react';
          ...
          <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
            ...
            <div className="space-y-4">
              <div>
                ...
                <select className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500">
              ...
              <div>
                ...
                <div className="flex gap-3 mt-1">
                  {stations.map(s => (
                    <button key={s} className="flex-1 rounded-md border-2 border-gray-200 px-3 py-2 text-sm font-medium text-gray-600 hover:border-primary-300">
            ...
            <div className="flex justify-end gap-3 mt-6">
              <button onClick={() => setShowAssignModal(false)} className="rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">Cancel</button>
              <button className="rounded-md bg-primary-600 px-4 py-2 text-sm font-medium text-white hover:bg-primary-700">Assign</button>
            </div>
          </div>
        </div>
      )}
